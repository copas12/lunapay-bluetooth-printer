...
public class RNBluetoothEscposPrinterModule extends ReactContextBaseJavaModule
    ...
    /**
     * When n=0 or 48, left justification is enabled When n=1 or 49, center
     * justification is enabled When n=2 or 50, right justification is enabled
     * 
     * @param align
     * @param promise
     */
    ...
    public void printColumn(ReadableArray columnWidths, ReadableArray columnAligns, ReadableArray columnTexts,
        ...
        /**
         * [column1-1, column1-2, column1-3 ... column1-n] , [column2-1, column2-2,
         * column2-3 ... column2-n]
         *
         * ...
         *
    ...
    @ReactMethod
    public void printPicCenter(String base64encodeStr, @Nullable ReadableMap options) {
        int width = 0;
        int leftPadding = 0;
        if (options != null) {
            width = options.hasKey("width") ? options.getInt("width") : 0;
